...
def create_model_and_diffusion(
    ...
    # input("stop here model created in scrip util: ")
...
def create_model(
    ...
    attention_ds = [] # attention downsampling
    for res in attention_resolutions.split(","):
        attention_ds.append(image_size // int(res))
    # input("stop here: ")
    return DiT().to("cuda:0")
    # return UNetModel(
...
def create_gaussian_diffusion(
    *,
    ...
    # input("Stop here create gaussian diffusion scrip util: ")
