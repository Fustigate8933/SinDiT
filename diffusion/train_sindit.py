...
logging.basicConfig(filename="./cleandit/training_log.txt", level=logging.DEBUG, filemode="a", format="[%(asctime)s] %(message)s")
...
for i in range(len(data)):
    ...
    save_path = f"./cleandit/models/{class_names[i]}.pt"
